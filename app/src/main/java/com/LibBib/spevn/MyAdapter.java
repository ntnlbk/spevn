...
public class MyAdapter extends ArrayAdapter<String> implements Filterable {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!audiochoose)
                    ...
                    ((MyIntefrace)context).audiochoose(resource[position]);
                }
            }
        });
    ...
    public MyAdapter(Context context, String[] resource, String[] alwaysthesame, String c, boolean longclick, ArrayList<String> checkedpos, Map<String, String> types, boolean isfromplaylist, String nameofplaylist, Boolean audiochoose) {
